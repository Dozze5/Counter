...
function App() {
  ...
  return (
     <div className = "w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-12 ">

      <div className=" text-[#0398d4] font-medium text-2xl">Increament and Deacreament</div>

      <div className="flex bg-white items-center gap-12 py-3 rounded-sm text-[25px] text-[#344151]">
